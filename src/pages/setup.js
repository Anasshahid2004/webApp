  ...
  return (
    ...
    <section className="dark:bg-[#0e0e0e] dark:text-gray-100">
		...
		<div className="grid justify-center grid-cols-1 gap-14 sm:grid-cols-2 lg:grid-cols-2">
			<a rel="noopener noreferrer" href="#" className="md:max-w-md mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083314687636164619/key-1024x446.png?width=996&height=434" />
			</a>
			<a rel="noopener noreferrer" href="#" className="md:max-w-md mx-auto group hover:no-underline focus:no-underline my-auto">
            <div className="p-6">
                <h3 className="text-3xl font-[700] group-hover:underline group-focus:underline text-center text-[#FF7825]">HAVIT MECHANICAL KEYBOARD</h3>
            ...
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083314687397081088/mouse2-1.png?width=357&height=434" />
			</a>
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline my-auto">
            <div className="p-6">
                <h3 className="text-3xl font-[700] group-hover:underline group-focus:underline text-center text-[#FF7825]">HOLIFE ERGONOMIC MOUSE</h3>
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083314687128637480/mon.png?width=551&height=434" />
			</a>
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline my-auto">
            <div className="p-6">
                <h3 className="text-3xl font-[700] group-hover:underline group-focus:underline text-center text-[#FF7825]">AOC 24&#34; MONITOR</h3>
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083314686876995635/mic-996x1024.png?width=422&height=434" />
			</a>
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline my-auto">
            <div className="p-6">
                <h3 className="text-3xl font-[700] group-hover:underline group-focus:underline text-center text-[#FF7825]">TONOR Q9 MICROPHONE</h3>
            ...
            <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083314686654689420/draw.png?width=583&height=434" />
			</a>
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline my-auto">
            <div className="p-6">
                <h3 className="text-3xl font-[700] group-hover:underline group-focus:underline text-center text-[#FF7825]">DRAWING TABLET</h3>
