  ...
  return (
    ...
    <section className="dark:bg-[#0e0e0e] dark:text-gray-100">
		...
		<div className="grid justify-center grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051435530395759/mugth.png?width=448&height=434" />
                <div className="p-6">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051435295527002/shirtth.png?width=448&height=434" />
            <div className="p-6">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051435010306048/padth.png?width=448&height=434" />
            <div className="p-6">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051434783809536/capth.png?width=448&height=434" />
            <div className="p-6">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051434536357978/phoneth.png?width=448&height=434" />
          <div className="p-6">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051434309849169/stickerth.png?width=448&height=434" />
          <div className="p-6">
    ...
    <section className="dark:bg-[#0e0e0e] dark:text-gray-100">
		...
		<div className="grid justify-center grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-2">
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051434104332329/gm2-1.jpg?width=461&height=434" />
                <div className="p-6">
			...
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline">
            <Image alt="presentation" className="mx-auto object-cover w-fit rounded-lg h-fit" width={480} height={420} src="https://media.discordapp.net/attachments/807562739324157962/1083051433915601019/om2.jpg?width=461&height=434" />
            <div className="p-6">
